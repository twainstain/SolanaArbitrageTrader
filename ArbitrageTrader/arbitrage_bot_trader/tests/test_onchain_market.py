...
from arbitrage_bot.onchain_market import OnChainMarket, OnChainMarketError
...
class OnChainMarketInitTests(unittest.TestCase):
    @patch("arbitrage_bot.onchain_market.Web3")
...
class OnChainMarketQuoteTests(unittest.TestCase):
    def _build_market_with_mocked_contracts(
        ...
        with patch("arbitrage_bot.onchain_market.Web3") as MockWeb3:
        ...
        with patch("arbitrage_bot.onchain_market.Web3") as MockWeb3:
            ...
            import arbitrage_bot.onchain_market as ocm
